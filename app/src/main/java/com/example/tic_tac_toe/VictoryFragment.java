...
public class VictoryFragment extends Fragment {
    ...
    public VictoryFragment(AppCompatActivity appCompatActivity,String time) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        // 解析fragment的布局文件
        View rootView = inflater.inflate(R.layout.fragment_victory, container, false);

        yes = rootView.findViewById(R.id.victoryYes);
        no = rootView.findViewById(R.id.victoryNo);
